...
public class WindowExample2 {
	...
	public static void main(String[] args) {
		...
		button.addActionListener(new ConfirmButtonActionListener(text, label, text, label));
		text.addActionListener(new ConfirmButtonActionListener(text, label, text, label));
